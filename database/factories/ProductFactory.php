...
$factory->define(App\Models\Product::class, function (Faker $faker) use ($price){
    return [
        ...
        'category_id'=> App\Models\Category::whereNotNull('parent_id')->inRandomOrder()->first() ,
        'brand_id'=> App\Models\Brand::inRandomOrder()->first() ,
        'stock' => random_int(30,1000),
        'min_stock' => random_int(1,8),
        'special' => 1,
        'active' => 1,
    ];
});
