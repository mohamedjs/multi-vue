  ...
  methods: {
    ...
    loginJWT: function loginJWT() {
      ...
      this.$store.dispatch('auth/Login', payload).then(function () {
        ...
        redirect_after_login = _this.$route.query.to ? _this.$route.query.to : '/';

        _this.$router.push(redirect_after_login).catch(function () {});
        ...
        if (error.response.status == 422) //validation error
          {
            _this.errors.setErrors(error.response.data.data);
          }

        if (error.response.status == 417) //unauthorized
          {
            _this.res_credentials = true;
          }
      });
    }
  }
    ...
    [
          ...
          directives: [
            {
              name: "show",
              rawName: "v-show",
              value: _vm.res_credentials && !_vm.errors.has("email"),
              expression: "res_credentials && !errors.has('email')"
            }
          ],
      ...
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("span", { staticClass: "text-danger text-sm" }, [
            _vm._v(_vm._s(_vm.errors.first("checkbox_remember_me")))
          ]),
          _vm._v(" "),
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _LoginJWT_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _LoginJWT_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
