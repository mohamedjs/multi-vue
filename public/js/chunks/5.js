  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("vs-avatar", {
            ...
            attrs: { src: _vm.authUser.image, size: "70px" }
          }),
          _vm._v(" "),
          _c("input", {
      ...
      _c("vs-input", {
        ...
        model: {
          value: _vm.authUser.user_name,
          callback: function($$v) {
            _vm.$set(_vm.authUser, "user_name", $$v)
          },
          expression: "authUser.user_name"
        }
      }),
      _vm._v(" "),
      _c("span", { staticClass: "text-danger text-sm" }, [
