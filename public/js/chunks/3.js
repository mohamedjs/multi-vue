...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    activeLink: function activeLink() {
      return this.$route.path.slice(1).includes(this.to.slice(1)) && this.to.slice(1) ? true : false; // return ((this.to == this.$route.path) || (this.$route.meta.parent == this.slug) && this.to) ? true : false
    }
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  computed: {
    i18n_locale_img: function i18n_locale_img() {
      ...
      if (locale == "en") return __webpack_require__(/*! @assets/images/flags/en.png */ "./resources/assets/images/flags/en.png");else if (locale == "ar") return __webpack_require__(/*! @assets/images/flags/ar.png */ "./resources/assets/images/flags/ar.png");
    },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    logout: function logout() {
      ...
      localStorage.removeItem('userInfo'); // logut out foreget token 
...
var VxTour = function VxTour() {
  return __webpack_require__.e(/*! import() */ 8).then(__webpack_require__.bind(null, /*! @/components/VxTour.vue */ "./resources/js/src/components/VxTour.vue"));
};
          ...
          _c(
            ...
            [
              _c("img", {
                staticClass: "h-4 w-5 mr-1",
                attrs: {
                  src: __webpack_require__(/*! @assets/images/flags/ar.png */ "./resources/assets/images/flags/ar.png"),
                  alt: "fr"
                }
              }),
              _vm._v("  Arabic")
...
/***/ "./resources/assets/images/flags/ar.png":
/*!**********************************************!*\
  !*** ./resources/assets/images/flags/ar.png ***!
  \**********************************************/
/*! no static exports found */
...
module.exports = "/images/ar.png?c44ff65b5273394a56bf5e4bfdda5899";
...
var data = [];
axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("/api/v1/items").then(function (response) {
  for (var i = 0; i < response.data.length; i++) {
    data.push(response.data[i]);
  }
});
/* harmony default export */ __webpack_exports__["default"] = (data); // export default [
//   // {
//   //   url: "/apps/email",
//   //   name: "Email",
//   //   slug: "email",
