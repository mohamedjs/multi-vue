                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                @can("create", \App\Models\Area::class)
                                    <a href="{{ route('admin.areas.create') }}" class="btn btn-sm btn-icon btn-outline-primary float-right">Create <span class="btn-inner--icon"><i class="fa fa-plus"></i></span></a>
                                @endcan
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    @if(auth()->user()->hasAccess("admin.areas.edit") || auth()->user()->hasAccess("admin.areas.destroy"))
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    @can("update", $item)
                                                        <a class="dropdown-item" href="{{ route("admin.areas.edit", ['area' => $item]) }}">Edit</a>
                                                    @endcan
                        ...
                        <div class="modal fade" id="delete_model_{{ $item->id }}" tabindex="-1" role="dialog"  aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('admin.areas.destroy', ['area' => $item]) }}" method="Post" >
                                        @method('DELETE')
                                        @csrf
