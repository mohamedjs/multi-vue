        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.areas.update', ['area' => $area]) }}" enctype="multipart/form-data" method="post">
                            @method('put')
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        ...
                                        <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                        <input type="text" class="form-control" name="name" id="name" value="{{ old('name', $area->name) }}" placeholder="Name">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    <label class="custom-toggle">
                                        <input type="checkbox" id="active" name="active" value="1"  {{ old("active", $area->active) == $status::ACTIVE ? "checked" : "" }}>
