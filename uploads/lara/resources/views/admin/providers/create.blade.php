        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.providers.store') }}" enctype="multipart/form-data" method="post">
                            @csrf
                            <h6 class="heading-small text-muted mb-4">Providers Information</h6>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        ...
                                        <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                        <input type="text" class="form-control" name="address" id="name" value="{{ old('address') }}" placeholder="Address">
                                    </div>
                                </div>
                            </div>
