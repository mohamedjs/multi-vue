<template>
  <vs-sidebar click-not-close position-right parent="body" default-index="1" color="primary" class="add-new-data-sidebar items-no-padding" spacer v-model="isSidebarActiveLocal">
    ...
    <VuePerfectScrollbar class="scroll-area--data-list-add-new pt-4 pb-6" :settings="settings">
      <div class="p-6">
            <div :key= "index" v-for="(lang, index) in langs" >
                <vs-input v-validate="'required'" :label="'Brand Title '+lang.short_code" :name="'title_'+lang.short_code" v-model="brand.title[lang.short_code]" class="w-full" />
                <span class="text-danger text-sm" v-show="errors.has('title_'+lang.short_code)">{{ errors.first('title_'+lang.short_code) }}</span>
            </div>
            <!-- IMG -->
